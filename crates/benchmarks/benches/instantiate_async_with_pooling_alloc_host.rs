...
use engine::v21::{
    self, Config as ConfigV21, Engine as EngineV21, Store as StoreV21, component::Component as ComponentV21,
    component::Linker as LinkerV21,
};
use engine::v41::{
    self, Config as ConfigV41, Engine as EngineV41, Store as StoreV41, component::Component as ComponentV41,
...
fn benchmark_v21(c: &mut Criterion, wasm_file: &str) {
    ...
    let group_name = format!(
        "instantiate_async_with_pooling_alloc_host_{}_v21",
...
fn benchmark_v41(c: &mut Criterion, wasm_file: &str) {
    ...
    let group_name = format!(
        "instantiate_async_with_pooling_alloc_host_{}_v41",
        wasm_file.replace(".wasm", ""),
    );
